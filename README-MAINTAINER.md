...
and fix them; assign them to a milestone (like `2.15.1`).
...
- add a new entry like _* v2.15.1_
- commit with a message like _prepare v2.15.1_
...
- `npm dist-tag add @micro-os-plus/build-helper@2.15.1 latest`
- `npm dist-tag ls @micro-os-plus/build-helper`
